...
## ⚡ העלאה מहירה ל-Netlify

> [!IMPORTANT]
> **כאשר המשתמש מבקש "להעלות לאוויר" או "לעשות deployment":**
> תמיד תן לו את הפקודה המשולבת הזו **בשורה אחת** להעתקה והרצה:

### פקודת העלאה (להעתקה):

```powershell
git add .; git commit -m "תיאור השינוי"; git push origin main
```

**החלף את "תיאור השינוי"** בתיאור קצר של מה ששונה.

הפרויקט מתארח ב-**Netlify** שמתעדכן אוטומטית מ-Git - **Netlify יעשה את השאר!**
