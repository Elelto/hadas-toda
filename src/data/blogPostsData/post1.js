...
const post1 = {
  ...
  image: "/images/uploads/gemini_generated_image_kytyv9kytyv9kyty.png",
  categories: ["speech", "adults", "tips"],
  content: `<p>גמגום הוא הפרעת תקשורת המאופיינת בשיבושים בשטף הדיבור, כגון חזרות על צלילים, הארכת צלילים או חסימות. בעוד שרבים מקשרים גמגום עם ילדות, עבור כ-1% מהאוכלוסייה הבוגרת, הגמגום הוא אתגר יומיומי המשפיע על התקשורת, הביטחון העצמי והאינטראקציות החברתיות והמקצועיות.</p>
