...
const post3 = {
  ...
  content: `<p>התערבות מוקדמת בהפרעות שפה ותקשורת נחשבת לאחד הגורמים המשמעותיים ביותר לשיפור התפקוד השפתי והחברתי של ילדים עם קשיים. מחקרים רבים מראים כי טיפול המתחיל בגיל צעיר מוביל לתוצאות טובות יותר בטווח הארוך.</p>
