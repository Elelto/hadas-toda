...
const post7 = {
  ...
  content: `<p>שינויים בקול וצרידות הם תופעות שכיחות בגיל המבוגר, ולעיתים מהווים סימן לבעיה רפואית או תפקודית. קלינאי תקשורת המתמחה בקול יכול לסייע באבחון, טיפול ומניעת סיבוכים.</p>
