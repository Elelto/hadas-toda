...
const post8 = {
  ...
  content: `<p>הקול שלנו הוא כלי תקשורת חיוני, אך לעתים קרובות אנחנו מתייחסים אליו כמובן מאליו עד שמתעוררת בעיה. בדומה לשרירים אחרים בגוף, גם מיתרי הקול ומערכת הפקת הקול זקוקים לתרגול ותחזוקה שוטפת.</p>
