...
const post9 = {
  ...
  content: `<p>אפרקסיה של הדיבור בילדות (Childhood Apraxia of Speech - CAS) היא הפרעה נוירולוגית-מוטורית המשפיעה על יכולתו של הילד לתכנן ולבצע את התנועות המדויקות הנדרשות להפקת דיבור ברור. זוהי הפרעה שאינה נובעת מחולשת שרירים, אלא מקושי בתכנון ובביצוע רצף תנועות מדויק.</p>
