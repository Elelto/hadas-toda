...
const OnlineTherapy = () => {
    ...
    const seoData = {
        ...
        keywords: "קלינאית תקשורת אונליין, הדס תודה אונליין, טיפול גמגום אונליין, קלינאית תקשורת זום, טיפול קול מרחוק, טיפול בצרידות אונליין, טיפול שפה מרחוק, קלינאית תקשורת ישראל, קלינאית תקשורת מרחוק, טלרפואה קלינאות תקשורת",
