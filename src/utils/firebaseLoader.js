  ...
  try {
    ...
    if (docSnap.exists()) {
      ...
      if (collectionName === 'components' && docId === 'header') {
        ...
        if (dataString.includes('בני ברק') || !dataString.includes('טיפול אונליין') || dataString.includes('"אודות"') || dataString.includes('"שירותים"') || dataString.includes('"המלצות"') || dataString.includes('"בית"') || dataString.includes('"יצירת קשר"')) {
